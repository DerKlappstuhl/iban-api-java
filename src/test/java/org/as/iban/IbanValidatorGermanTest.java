...
public class IbanValidatorGermanTest {
	...
	try {
	    iban = new IbanImpl("DE04500502221241539870");
	    assertFalse(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
	...
	try {
	    iban = new IbanImpl("DE12360700240001234567");
	    assertFalse(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
	...
	try {
	    iban = new IbanImpl("DE39360700240123456700");
	    assertTrue(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
	...
	try {
	    iban = new IbanImpl("DE86350601900008090100");
	    assertTrue(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
	...
	try {
	    iban = new IbanImpl("DE16100000001234400012");
	    assertTrue(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
...
//    }
	...
	try {
	    iban = new IbanImpl("DE96290101111611754300");
	    assertTrue(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
    ...
    @Test
    public void rule005700() {
	Iban iban = null;
	
	try {
	    iban = new IbanImpl("DE97660102009988776655");
	    assertTrue(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
	...
	try {
	    iban = new IbanImpl("DE48508109009988776655");
	    assertFalse(iban.validate());
	} catch (IbanException e) {
	    e.printStackTrace();
	}
